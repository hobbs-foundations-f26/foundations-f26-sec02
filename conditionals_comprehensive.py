...
# this does the same as above, replacing the elif portions
if grade >= 90:
    print("Grade: A")
else:
    if grade >= 80:
...
# the above can be preferable to using an and:
if is_active_account and user_role == "admin":
    print("Access granted: Full admin panel.")
elif is_active_account and not user_role == "admin":
        print("Access granted: Standard user dashboard.")
else:
    print("Access denied: Account suspended.")
